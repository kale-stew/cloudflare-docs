...
- **The export is temporary.** The repository is deleted automatically about 36 hours after it is created, and the clone credential expires about an hour after it is issued. Clone promptly, then push to a repository you control.
