...
:::note[Beta]
Agent Lee is currently in beta and available to accounts on Free and self-serve paid plans. Features and behaviors may change.
:::
...
If you prefer, you can also use Agent Lee in [read-only mode](/agent-lee/manage-availability/), which prevents all write operations without removing access to questions and diagnostics.
...
- [Manage Agent Lee availability](/agent-lee/manage-availability/)
- [Agents SDK](/agents/)
